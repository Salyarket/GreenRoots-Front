...
import { archiveProduct } from "@/services/admin.api";
import { MdDeleteOutline } from "react-icons/md";
import { IProduct } from "@/types/index.types";

export default function DeleteButton({ product }: { product: IProduct }) {
  ...
  const handleDelete = async () => {
    try {
      ...
      setOpen(false);
      alert(`✅ Produit ${product.name} archivé avec succès`);
