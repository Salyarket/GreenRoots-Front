          ...
          <div>
            <div className="flex flex-col md:flex-row md:justify-between md:items-center">
              ...
              <div className="flex items-center justify-center mb-6 md:mb-0">
                <button className="text-white bg-brand-green px-4 py-2 font-bold rounded-full cursor-pointer hover:bg-brand-lightgreen">
                  -
                </button>
              ...
              <button className="flex items-center justify-center text-white bg-brand-green px-6 py-2 font-bold rounded-lg cursor-pointer hover:bg-brand-lightgreen">
                Ajouter
                <Image
                  src="/icon_cart.svg"
                  alt="GreenRoots"
            ...
            <button className="text-center text-white bg-brand-green w-full py-2 font-bold rounded-lg cursor-pointer hover:bg-brand-lightgreen mt-10">
              Achat Direct
            </button>
          </div>
        </article>
